            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="uclist mt10">
                        <ul class="list1 fl">
                            <li><a href="">用户信息></a></li>
                            <li><a href="<?=\yii\helpers\Url::to(['order/my-order'])?>">我的订单></a></li>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    <h3><a href="<?=\yii\helpers\Url::to(['list/index','goods_category_id'=>$goods_category->id])?>"><?=$goods_category->name?></a> <b></b></h3>
                    <div class="cat_detail">
                        <?php $goods_category2s=\backend\models\GoodsCategory::find()->where(['parent_id'=>$goods_category->id])->all()?>
                        <?php foreach ($goods_category2s as $goods_category2):?>
                        <dl class="dl_1st">
                            <dt><a href="<?=\yii\helpers\Url::to(['list/index','goods_category_id'=>$goods_category2->id])?>"><?=$goods_category2->name?></a></dt>
                            <?php $goods_category3s=\backend\models\GoodsCategory::find()->where(['parent_id'=>$goods_category2->id])->all()?>
                            <dd>
                                <?php foreach ($goods_category3s as $goods_category3):?>
                                <a href="<?=\yii\helpers\Url::to(['list/index','goods_category_id'=>$goods_category3->id])?>"><?=$goods_category3->name?></a>
                                <?php endforeach;?>
                            </dd>
