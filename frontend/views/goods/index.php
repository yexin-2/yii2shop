        ...
        <div class="summary">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$p->path?>',largeimage:'<?=$p->path?>'}"><img src="<?=$p->path?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="" id="read" date="<?=$goods->view_times?>">(已有<?=$goods->view_times?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var read=$('#read').attr('date')-0+1;
        var id=$('#id').val();
        $.get('ajax.html',{'id':id},function () {

        },'json')
        $('#read').text('(已有'+read+'人评价)')
    }
    )
</script>
</body>
